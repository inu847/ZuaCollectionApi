        ...
        <div class="col-md-6">
            <div class="white-box form-horizontal m-t-10">
                        ...
                        <div class="row">
                            <div class="col-md-2">                                    
                                <div class="checkbox checkbox-info checkbox-circle">
                                    <input class="form-control" {{$baju->status == "PROCESS" ? "checked" : ""}} value="PROCESS" id="PROCESS" type="checkbox" name="status">
                                    <label for="PROCESS">PROCESS</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="checkbox checkbox-success checkbox-circle">
                                    <input class="form-control" {{$baju->status == "SUCCESS" ? "checked" : ""}} value="SUCCESS" id="SUCCESS" type="checkbox" name="status">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                        <input value="{{$baju->lingkar_badan}}" type="text" class="form-control {{$errors->first('lingkar_badan') ? "is-invalid": ""}}" id="lingkar_badan" name="lingkar_badan" placeholder="Lingkar Badan"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->lingkar_pinggang}}" type="text" class="form-control {{$errors->first('lingkar_pinggang') ? "is-invalid": ""}}" id="lingkar_pinggang" name="lingkar_pinggang" placeholder="Lingkar Pinggang"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->lingkar_pinggul}}" type="text" class="form-control {{$errors->first('lingkar_pinggul') ? "is-invalid": ""}}" id="lingkar_pinggul" name="lingkar_pinggul" placeholder="Lingkar Pinggul"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->lingkar_pipa}}" type="text" class="form-control {{$errors->first('lingkar_pipa') ? "is-invalid": ""}}" id="lingkar_pipa" name="lingkar_pipa" placeholder="Lingkar Pipa"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->lingkar_paha}}" type="text" class="form-control {{$errors->first('lingkar_paha') ? "is-invalid": ""}}" id="lingkar_paha" name="lingkar_paha" placeholder="Lingkar Paha"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->lingkar_lutut}}" type="text" class="form-control {{$errors->first('lingkar_lutut') ? "is-invalid": ""}}" id="lingkar_lutut" name="lingkar_lutut" placeholder="Lingkar Lutut"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->lebar_muka}}" type="text" class="form-control {{$errors->first('lebar_muka') ? "is-invalid": ""}}" id="lebar_muka" name="lebar_muka" placeholder="Lebar Muka"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->lebar_punggung}}" type="text" class="form-control {{$errors->first('lebar_punggung') ? "is-invalid": ""}}" id="lebar_punggung" name="lebar_punggung" placeholder="Lebar Punggung"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        <label for="lebar_lengan" class="col-sm-3 control-label p-b-30">Lebar Lengan*</label>
                        <div class="col-sm-9">
            ...
            <div class="col-md-6">
                <div class="white-box form-horizontal m-t-10">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->lebar_ban_lengan}}" type="text" class="form-control {{$errors->first('lebar_ban_lengan') ? "is-invalid": ""}}" id="lebar_ban_lengan" name="lebar_ban_lengan" placeholder="Lebar Ban Lengan"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->panjang_punggung}}" type="text" class="form-control {{$errors->first('panjang_punggung') ? "is-invalid": ""}}" id="panjang_punggung" name="panjang_punggung" placeholder="Panjang Punggung"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->panjang_muka}}" type="text" class="form-control {{$errors->first('panjang_muka') ? "is-invalid": ""}}" id="panjang_muka" name="panjang_muka" placeholder="Panjang Muka"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->panjang_baju}}" type="text" class="form-control {{$errors->first('panjang_baju') ? "is-invalid": ""}}" id="panjang_baju" name="panjang_baju" placeholder="Panjang Baju"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->panjang_lengan}}" type="text" class="form-control {{$errors->first('panjang_lengan') ? "is-invalid": ""}}" id="panjang_lengan" name="panjang_lengan" placeholder="Panjang Lengan"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->panjang_rok}}" type="text" class="form-control {{$errors->first('panjang_rok') ? "is-invalid": ""}}" id="panjang_rok" name="panjang_rok" placeholder="Panjang Rok"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->panjang_celana}}" type="text" class="form-control {{$errors->first('panjang_celana') ? "is-invalid": ""}}" id="panjang_celana" name="panjang_celana" placeholder="Panjang Celana"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{$baju->panjang_krah}}" type="text" class="form-control {{$errors->first('panjang_krah') ? "is-invalid": ""}}" id="panjang_krah" name="panjang_krah" placeholder="Panjang Krah"> 
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-offset-3 waves-effect">
                        <button class="btn btn-danger waves-light m-l-15" type="submit" value="save">Submit</button>
                    </div>
                </div>
            </div>
        </form>
