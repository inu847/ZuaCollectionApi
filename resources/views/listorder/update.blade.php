                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 m-t-10" for="address">Address</label>
                                                <div class="col-md-5 m-b-10">
                                                    <input value="{{$product->address}}" type="text" class="form-control {{$errors->first('address') ? "is-invalid": ""}}" id="address" placeholder="Take Your Address Here" name="address"> 
                                                    <span class="help-block">{{$errors->first('address')}}</span>
                                                </div>
                                                    <div class="col-md-2 m-b-10">
                                                        <input value="{{$product->rt}}" type="text" class="form-control {{$errors->first('rt') ? "is-invalid": ""}}" id="rt" placeholder="RT" name="rt">
                                                    </div>                
